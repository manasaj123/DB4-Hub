...
exports.delete = async (req, res) => {
  ...
  try {
    ...
    await conn.query('DELETE FROM bom WHERE product_id = ? OR material_id = ?', [id, id]);
    await conn.query('DELETE FROM mrp_requirements WHERE product_id = ? OR material_id = ?', [id, id]);
