...
//   const handleConvertToOrder = async (inquiryId) => {
//     if (!window.confirm("Create a sales order from this inquiry?")) return;
//     try {
//       const res = await convertInquiryToOrder(inquiryId);
//       alert(`Sales Order ${res.data.id} created successfully`);
//       loadData();
//     } catch (err) {
...
//                         onClick={() => handleConvertToOrder(inq.id)}
//                       >
//                         Create Sales Order
//                       </button>
//                     </>
